...
namespace HmPro.Windows
{
    ...
    {
        private void MaximizeCmd_MouseDown(object sender, MouseButtonEventArgs e) //Sets the window state to maximize.
        {
            this.WindowState = WindowState.Maximized;
        }
        private void MinimizeCmd_MouseDown(object sender, MouseButtonEventArgs e)//Sets the window state to minimized.
        {
            this.WindowState = WindowState.Minimized;
        }
        private void NormalCmd_MouseDown(object sender, MouseButtonEventArgs e) //Sets the window state to normal.
        {
            this.WindowState = WindowState.Normal;
        }
        private void AutoSizeCmd_MouseDown(object sender, MouseButtonEventArgs e) //If the state is normal, it maximizes. If it is maximized, it sets it to normal.
        {
        ...
        private void WelcomeScreenCmd_MouseDown(object sender, MouseButtonEventArgs e) //Loads the welcome screen.
        {
