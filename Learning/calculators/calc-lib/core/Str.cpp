...
namespace Core
{
    ...
    {
        return static_cast<unsigned int>(lstrlenW(Text));
    }

    void String::AssignByChars(const wchar_t* Chars)
    {
        int Len = lstrlenW(Chars) + 1;
        _Len = static_cast<unsigned int>(Len);
        _Compacity = _Len + 5;
    ...
    bool String::RemoveAt(unsigned int Index)
    {
        ...
        unsigned int FirstSize = (_Len - Index + 1);
    ...
    bool String::RemoveRange(unsigned int Begin, unsigned int End)
    {
    ...
    String String::FilterToNum(bool NegitiveNumbers, bool Decimals) const
    {
        ...
        for (unsigned int i = 0; i < Base._Len; i++)
        {
            wchar_t Item = Base[i];
    ...
    {
        String Return = L"";
        unsigned int LastIndex = Parts.Size - 1;
    ...
    bool String::Contains(String Obj) const
    {
        ...
        for (unsigned int i = 0u; i < _Len; i++)
        {
            ...
            {
                bool Return = true;
                for (unsigned int j = i + 1, m = 0u; j < _Len && m < Obj._Len; j++, m++)
    ...
    unsigned int String::CountOf(const wchar_t& Delemeter) const
    {
        const String& Base = *this;
        unsigned int Return = 0;
        for (unsigned int i = 0; i < _Len; i++)
    ...
    unsigned int String::IndexOf(const wchar_t& Item) const
    {
        for (unsigned int i = 0; i < _Len; i++)
        {
            if (operator[](i) == Item)
    ...
    unsigned int String::GetStrLen(const wchar_t*& Chars)
    {
        return lstrlenW(Chars);
    }
    unsigned int String::GetStrLen(const char*& Chars)
    {
    ...
    String& String::operator+=(const String& Two)
    {
        ...
        {
            unsigned int Size = _Len + Two._Len;
        ...
        {
            unsigned int Size = _Len + Two._Len, Comp = Size + 20;
    ...
    {
        wchar_t* Text;
        unsigned int Comp = Two._Len + One._Len + 1;
        unsigned int Size = Two._Len + One._Len;
    ...
    {
        wchar_t* Text;
        unsigned int Comp = 1 + One._Len + 1;
        unsigned int Size = 1 + One._Len;
    ...
    {
        wchar_t* Text;
        unsigned int Comp = Two._Len + 1 + 1;
        unsigned int Size = Two._Len + 1;
    ...
    bool operator==(const String& One, const String& Two)
    {
        ...
        bool Return = true;
        for (unsigned int i = 0; i < One._Len; i++)
            Return &= One[i] == Two[i];
