...
namespace Mason::UI::Search
{
	using namespace Files;

	SearchByName::SearchByName(Files::SearchCriteria& Criteria, Project* File)
	{
	...
	Vector<Component*> SearchByName::Execute(Files::SearchCriteria& Criteria, HINSTANCE ins, Project* File)
	{
