...
namespace Mason::UI::Tool
{
	...
	ComponentListRenderer::ComponentListRenderer(const Vector<ComponentReference*>& Source, HINSTANCE ins, String WindowTitle, bool CanEdit) : ComponentListRenderer(ComponentReference::Convert(Source), ins, WindowTitle, CanEdit) {}
	...
	{
		ChangeSource(ComponentReference::Convert(Source));
	}
	...
	void ComponentListRenderer::LoadControls()
	{
...

		{
			...
			int Height = 40;
			int XCoord = 10;
			int YCoord = (WndRect.bottom / 2) - (Height + Spacing);
