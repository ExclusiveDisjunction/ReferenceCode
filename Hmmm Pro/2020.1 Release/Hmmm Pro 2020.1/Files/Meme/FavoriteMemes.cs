...
{
    /// <summary>
    /// Another type of MemeList, but this focus on LegendaryMemes. This can enumerate into Meme.
    /// </summary>
    public sealed class FavoriteMemes : IComponentList<Meme>
    {
        ...
        internal FavoriteMemes(Session File) //Loads the class, using the session to save from, pull memes, and set the parent from.
        {
            this.File = File;
            this.Parent = File.Document.DocumentElement.ChildNodes.Item(0);
        ...
        {
            return obj is FavoriteMemes && obj as FavoriteMemes == this;
        }
        public bool Equals(IComponentList<Meme> other)
        {
            return other is FavoriteMemes && other as FavoriteMemes == this;
        }
        ...
        public static bool operator ==(FavoriteMemes One, FavoriteMemes Two)
        {
