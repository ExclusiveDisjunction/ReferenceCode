...
namespace HmPro.Events
{
    ...
    /// </summary>
    public sealed class ObjectSelectionArgs : EventArgs
    {
        /// <summary>
        ...
        public ObjectSelectionArgs(IComponent Object, bool Connected, Session Source)
        {
            if (!Connected)
            {
                Object = null;
        ...
        public ObjectSelectionArgs(IComponent Object, bool Connected, Session Source, string Notes)
        {
            if (!Connected)
            {
                Object = null;
