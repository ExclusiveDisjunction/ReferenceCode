...
namespace Mason::UI::Controls
{
	...
	class CheckableButton : public StyledControl
	{
	private:
	...
	public:
		CheckableButton(int X, int Y, int Width, int Height, HWND Parent, HINSTANCE ins, HMENU ID, bool IsChecked, Core::String Text, CheckableButtonType Type, StyleSheet Style, TextStyleSheet TextStyle);
		CheckableButton(int X, int Y, int Width, int Height, ControlBase* Parent, HINSTANCE ins, HMENU ID, bool IsChecked, Core::String Text, CheckableButtonType Type, StyleSheet Style, TextStyleSheet TextStyle) : CheckableButton(X, Y, Width, Height, *Parent, ins, ID, IsChecked, Text, Type, Style, TextStyle) {}
