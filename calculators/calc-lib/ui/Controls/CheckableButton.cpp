...
namespace Mason::UI::Controls
{
	...
	LRESULT CheckableButton::Paint()
	{
		...
		Color Hover = _Style.BorderBrush;
		Hover.Reduce(0.7f);
		Color BkColor = Checked ? _Style.BorderBrush : _Style.Background;
		Color ForegroundColor = _TextStyle.Foreground;
		Color BorderColor = _Style.BorderBrush;
