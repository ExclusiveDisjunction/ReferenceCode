...
#include "..\Controls\EditorButton.h"
...
namespace Mason::UI::Editors
{
	...
	{
		for (unsigned int i = 0; i < EditorButtons.Size; i++)
		{
	...
	void EditorButtonHost::LoadEditorButtonsBase(HWND Parent, HINSTANCE ins, int XCoord, int YCoord, int Width, int Height, Color BaseBk)
	{
		StyleSheet Style;
	...
	{
		Vector<Editor*> AllEditors = EditorRegistry::GetEditors(EDT_All, this);
