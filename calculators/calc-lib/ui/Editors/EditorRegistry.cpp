...
namespace Mason::UI::Editors
{
    ...
    void EditorRegistry::Track(EditorButtonHost* ButtonHost)
    {
        ...
        for (unsigned int i = 0; i < ToRef->EditorButtons.Size; i++)
    ...
    void EditorRegistry::ExitRegistry()
    {
        ...
        for (unsigned int i = 0; i < ButtonHosts.Size; i++)
        {
