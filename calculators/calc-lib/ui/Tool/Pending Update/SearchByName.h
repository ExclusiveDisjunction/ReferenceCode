...
namespace Mason
{
	...
	namespace UI
	{
		...
		namespace Search
		{
			...
			{
			private:
				SearchByName(Files::SearchCriteria& Criteria, Files::Project* Target);
			...
			public:
				...
				static Vector<Files::Component*> Execute(Files::SearchCriteria& Criteria, HINSTANCE Instance, Files::Project* SourceFile = nullptr);
